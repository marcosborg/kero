    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vendors.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_email') ? 'is-invalid' : '' }}" type="email" name="support_email" id="support_email" value="{{ old('support_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_phone') ? 'is-invalid' : '' }}" type="text" name="support_phone" id="support_phone" value="{{ old('support_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('invoice_name') ? 'is-invalid' : '' }}" type="text" name="invoice_name" id="invoice_name" value="{{ old('invoice_name', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Vendor::PAYOUT_METHOD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('payout_method') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="payout_method_{{ $key }}" name="payout_method" value="{{ $key }}" {{ old('payout_method', 'bank_transfer') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('payout_data') ? 'is-invalid' : '' }}" name="payout_data" id="payout_data">{{ old('payout_data') }}</textarea>
