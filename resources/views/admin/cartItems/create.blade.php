    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cart-items.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_cents') ? 'is-invalid' : '' }}" type="number" name="price_cents" id="price_cents" value="{{ old('price_cents', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal_cents') ? 'is-invalid' : '' }}" type="number" name="subtotal_cents" id="subtotal_cents" value="{{ old('subtotal_cents', '') }}" step="0.01" required>
