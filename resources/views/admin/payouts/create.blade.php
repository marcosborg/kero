    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payouts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('period_start') ? 'is-invalid' : '' }}" type="text" name="period_start" id="period_start" value="{{ old('period_start') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('period_end') ? 'is-invalid' : '' }}" type="text" name="period_end" id="period_end" value="{{ old('period_end') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gross_cents') ? 'is-invalid' : '' }}" type="number" name="gross_cents" id="gross_cents" value="{{ old('gross_cents', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commissions_cents') ? 'is-invalid' : '' }}" type="number" name="commissions_cents" id="commissions_cents" value="{{ old('commissions_cents', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refunds_cents') ? 'is-invalid' : '' }}" type="number" name="refunds_cents" id="refunds_cents" value="{{ old('refunds_cents', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('net_cents') ? 'is-invalid' : '' }}" type="number" name="net_cents" id="net_cents" value="{{ old('net_cents', '') }}" step="1" required>
