...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="price_cents">{{ trans('cruds.product.fields.price_cents') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.price_cents_helper') }}</span>
            </div>
            <div class="form-group">
                <div class="form-check {{ $errors->has('stock') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="stock" value="0">
                    <input class="form-check-input" type="checkbox" name="stock" id="stock" value="1" {{ old('stock', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="stock">{{ trans('cruds.product.fields.stock') }}</label>
                </div>
                @if($errors->has('stock'))
                    <div class="invalid-feedback">
                        {{ $errors->first('stock') }}
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Product::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', 'draft') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <label for="dimensions">{{ trans('cruds.product.fields.dimensions') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.dimensions_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="seo">{{ trans('cruds.product.fields.seo') }}</label>
                <input class="form-control {{ $errors->has('seo') ? 'is-invalid' : '' }}" type="text" name="seo" id="seo" value="{{ old('seo', '') }}">
                @if($errors->has('seo'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seo') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.seo_helper') }}</span>
            </div>
            <div class="form-group">
