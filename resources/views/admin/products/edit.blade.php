    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('vendor') ? 'is-invalid' : '' }}" name="vendor_id" id="vendor_id" required>
                    @foreach($vendors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('vendor_id') ? old('vendor_id') : $product->vendor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_cents') ? 'is-invalid' : '' }}" type="number" name="price_cents" id="price_cents" value="{{ old('price_cents', $product->price_cents) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('stock') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="stock" id="stock" value="1" {{ $product->stock || old('stock', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $product->weight) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dimensions') ? 'is-invalid' : '' }}" type="text" name="dimensions" id="dimensions" value="{{ old('dimensions', $product->dimensions) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo') ? 'is-invalid' : '' }}" type="text" name="seo" id="seo" value="{{ old('seo', $product->seo) }}">
                @if($errors->has('seo'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seo') }}
                    </div>
